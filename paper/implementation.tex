...
PLSI's floorplanning system is based on generating heirarchical groups of
placeable elements, specifying hints as to how they should be arragned, and
...
building high performance processors.
